...
### Filtros de fecha en `qa_executive` (Trend Range / today fijo / latest)

Para evitar que KPI diarios tomen máximos históricos, en
`simple/looker/qa_executive.dashboard` se aplica esta regla:

- **KPIs diarios** usan filtro fijo `qa_executive_kpis.metric_date: today`.
- **KPIs de tendencia** (series temporales) respetan **Trend Range**.
- **KPIs latest/snapshot** usan filtro fijo
  `qa_executive_kpis.is_latest_metric_ts_for_metric: Yes`.

Resumen actual:

- **Forzados a `today` (sin filtro global de fecha)**: `EXEC-01`, `EXEC-02`, `EXEC-03`, `EXEC-04`, `EXEC-18`, `EXEC-19`.
- **Respetan `Trend Range`**: `EXEC-05`, `EXEC-07`, `EXEC-08`, `EXEC-09`, `EXEC-11`, `EXEC-12`, `EXEC-13`, `EXEC-15`, `EXEC-16` (tile trend), `EXEC-22`, `EXEC-23`.
- **Siempre latest (sin listener de fecha)**: `EXEC-06`, `EXEC-10`, `EXEC-14`, `EXEC-16` (single value), `EXEC-17`, `EXEC-18/20` (pivot), `EXEC-21`, `EXEC-24`.
